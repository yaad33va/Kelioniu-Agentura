...
Route::post('/places/create', [TableController::class, 'createPlace'])->name('places.createPlace');
Route::get('/places/create', [TableController::class, 'showCreatePlace'])->name('places.showCreatePlace');
